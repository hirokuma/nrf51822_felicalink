...
#I2C
C_SOURCE_FILES += $(SDK_PATH)/components/drivers_nrf/twi_master/twi_sw_master.c
...
release: LINKER_SCRIPT=$(SDK_PATH)/components/toolchain/gcc/gcc_nrf51_$(NRF51_TYPE).ld
